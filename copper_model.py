...
try:
    st.set_page_config(page_title="Industrial Copper Modeling Application", page_icon=':trophy:',
                        layout='wide')
    #Background
    #st.markdown("""<style>.main {background-color: #EEBFEF;}</style>""",unsafe_allow_html=True)
    ...
    if selected == "Home":
        ...
        #with col2:
            #st.image(Image.open("C://Users//Dell//Desktop//youtube prject//copper_image1.webp"), width=500)
            #st.image(Image.open("C://Users//Dell//Desktop//youtube prject//copper_image2.webp"),width=500)
    ...
    if selected == "Predict Selling Price":
        ...
        if submit_button and flag == 0:
            ...
            with open("I:/projects/copper modeling/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)



            with open("I:/projects/copper modeling/scaler.pkl", 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open("I:/projects/copper modeling/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open("I:/projects/copper modeling/s.pkl", 'rb') as f:
    ...
    if(selected=="Predict Status"):
        ...
        if csubmit_button and cflag == 0:
            ...
            with open("I:/projects/copper modeling/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open("I:/projects/copper modeling/cscaler.pkl", 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open("I:/projects/copper modeling/ct.pkl", 'rb') as f:
